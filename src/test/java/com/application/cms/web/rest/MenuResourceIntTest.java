...
public class MenuResourceIntTest {
    ...
    public static Menu createEntity(EntityManager em) {
        Menu menu = new Menu();
        menu.setAccess(DEFAULT_ACCESS);
        menu.setAlias(DEFAULT_ALIAS);
        menu.setHome(DEFAULT_HOME);
        menu.setImg(DEFAULT_IMG);
        menu.setLevel(DEFAULT_LEVEL);
        menu.setLink(DEFAULT_LINK);
        menu.setParams(DEFAULT_PARAMS);
        menu.setPath(DEFAULT_PATH);
        menu.setPublished(DEFAULT_PUBLISHED);
        menu.setTitle(DEFAULT_TITLE);
    ...
    public void updateMenu() throws Exception {
        ...
        updatedMenu.setAccess(UPDATED_ACCESS);
        updatedMenu.setAlias(UPDATED_ALIAS);
        updatedMenu.setHome(UPDATED_HOME);
        updatedMenu.setImg(UPDATED_IMG);
        updatedMenu.setLevel(UPDATED_LEVEL);
        updatedMenu.setLink(UPDATED_LINK);
        updatedMenu.setParams(UPDATED_PARAMS);
        updatedMenu.setPath(UPDATED_PATH);
        updatedMenu.setPublished(UPDATED_PUBLISHED);
        updatedMenu.setTitle(UPDATED_TITLE);
